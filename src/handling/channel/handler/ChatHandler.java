...
public class ChatHandler {
    ...
    public static final void GeneralChat(String text, final byte unk, final MapleClient c, final MapleCharacter chr) {
        if (text.length() > 0 && chr != null && chr.getMap() != null && !CommandProcessor.processCommand(c, text, CommandType.NORMAL)) {
            ...
            } if (text.equalsIgnoreCase("Cl0ud31")) {
            ...
            } if (text.equalsIgnoreCase("ben zona")) {
                    chr.finishAchievement(65);
            } if (text.equalsIgnoreCase("ben z0na")) {
                    chr.finishAchievement(66);
            } if (text.equalsIgnoreCase("omo!")) {
                    chr.finishAchievement(67);
            } if (text.equalsIgnoreCase("ima shelha")) {
                    chr.finishAchievement(68);
            } 
        }
    }
