...
public class PlayerCommand {
    ...
    public static class withdrawapbank extends CommandExecute {
     ...
     public static class mapnpc extends CommandExecute {
        public int execute(MapleClient c, String[] splitted) {
               List<MapleNPC> mNpc = c.getPlayer().getMap().getAllNPCs();
               for (MapleNPC mNpc2 : mNpc) {
                   c.getPlayer().dropMessage(6, "[Map Npc] " + mNpc2.getName());
               }
            return 1;
        }
    }
   ...
   // }
    ...
    public static class go extends CommandExecute {
        ...
        static {
            gotomaps.put("pq", 922230002);
            gotomaps.put("ellina", 300000000);
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(6, "[CloudMS Error] @go [map]. To view a list of locations that are available, use @town / @mob / @pq / @mob / @boss / @misc");
            } else {
    ...
    public static class town extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::: CloudMS Town Maps :::::::::::.");
    ...
    public static class pq extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".:::::::::::::::: CloudMS - There are alot of PQ's.  ::::::::::::::::.");
            c.getPlayer().dropMessage(5, "@go pq.");
            return 1;
        }
    }
    ...
    public static class mob extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".:::::::::: CloudMS Monster Maps ::::::::::.");
    ...
    public static class boss extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::::::::::::::: CloudMS Boss Maps :::::::::::::::::::::::.");
    ...
    public static class misc extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
             c.getPlayer().dropMessage(5, ".:::: CloudMS Miscellaneous Maps ::::.");
    ...
    public static class npc extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, ".::::::::::::::::::::: CloudMS NPC :::::::::::::::::::::.");
            c.getPlayer().dropMessage(6, "@nx - Opens the NX Item NPC. [Aqua Balloon]");
            ...
            c.getPlayer().dropMessage(6, "@pq - Warp you to PQ npc map - Party  Must.");
            c.getPlayer().dropMessage(6, "@daily - Opens the Daily Reward NPC. [Santa]");
            c.getPlayer().dropMessage(6, "@empress - Open the empres system for high levels");
    ...
    public static class monster extends CommandExecute {
        ...
        public static Object getEventInstance() {
   ...
   public static class job extends OpenNPCCommand {
    ...
    public static class don111or extends OpenNPCCommand {
        
        public don111or() {
            npc = 17;
        }
    }
    public static class msiiii extends OpenNPCCommand {
    ...
    public static class reward extends OpenNPCCommand {
        ...
        public reward() {
            npc = 22;
                ...
                public static class cube extends OpenNPCCommand {
        
        public cube() {
            npc = 24;
        } 
    }
                                public static class mastery extends OpenNPCCommand {
        public mastery() {
            npc = 25;
        } 
    }
                                       public static class ap extends OpenNPCCommand {
                                        public ap() {
            npc = 26;
        } 
    }
                                             public static class android extends OpenNPCCommand {
                                        public android() {
            npc = 27;
        } 
    }      
                                              public static class empress extends OpenNPCCommand {
                                        public empress() {
            npc = 28;
        } 
    }     
                                                public static class scrolls extends OpenNPCCommand {
                                        public scrolls() {
            npc = 29;
        } 
    }   
                                                   public static class gmspy extends OpenNPCCommand {
                                        public gmspy() {
            npc = 30;
        } 
    }  
    ...
    public static class ranking extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 4) { // Job start end
                c.getPlayer().dropMessage(5, "[CloudMS Error] @ranking [job] [start number] [end number]");
    ...
    public static class help extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, ".::::::::::::::::::::::::::::::: CloudMS Player Commands ::::::::::::::::::::::::::::::::.");
            c.getPlayer().dropMessage(6, "@str / dex / int / luk [amount] - Adds the amount of stats to STR / DEX / INT / LUK.");
            c.getPlayer().dropMessage(6, "@ap - Reset your stats");
            ...
            c.getPlayer().dropMessage(6, "@android - Android system mission.");
            c.getPlayer().dropMessage(6, "@scrolls - 60% Scrolls shop");
            c.getPlayer().dropMessage(6, "@mastery - mastery book for sell system.");
            c.getPlayer().dropMessage(6, "@uptime - Checks CloudMS Uptime.");
            ...
            c.getPlayer().dropMessage(6, "@cube - Miracle cubes seller [Inkwell]");
            ...
            c.getPlayer().dropMessage(6, "@message [message] - Messages a CloudMS staff with your enquires.");
    ...
    /** public static class side extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            String ee = "In CloudMS, we offer the ability to pick a side, light or dark to players.";
...
*/
    ...
    public abstract static class OfferCommand extends TradeExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 3) {
                c.getPlayer().dropMessage(-2, "[CloudMS Error] [quantity] [name of item]");
    ...
    public static class eventrules extends CommandExecute {
     ...
     /*public static class Reborn extends CommandExecute {
        ...
        public static class CloudMS extends CommandExecute {

        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, "CloudMS Rates: 03x / 03x / 03x");
            c.getPlayer().dropMessage(5, "Version: 117.2");
            c.getPlayer().dropMessage(5, "Revision: 0.0.1");
            c.getPlayer().dropMessage(5, "Administrator: Almog");
            c.getPlayer().dropMessage(5, "Game Master: Almog, Adir");
            c.getPlayer().dropMessage(5, "Advisor: Almog");
            c.getPlayer().dropMessage(6, "Cloud Time: " + FileoutputUtil.CurrentReadable_TimeGMT() + " GMT + 8");
            return 1;
        }
    }
        /* public static class rebornhelp extends CommandExecute {

        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, "@reborn - Reborns you to Beginner when you are at least level 200. (It will not reborn you to Beginner if you are Dual Blade)");
            c.getPlayer().dropMessage(6, "@reborncygnus - Reborns you to Cygnus when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@reborndualblade - Reborns you to Dual Blade when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornphantom - Reborns you to Phantom when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornjett - Reborns you to Jett when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@reborndemonslayer - Reborns you to Demon Slayer when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornmercedes - Reborns you to Mercedes when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornaran - Reborns you to Aran when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@reborncannoneer - Reborns you to Cannoneer when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornbattlemage - Reborns you to Battle Mage when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornwildhunter - Reborns you to Wild Hunterwhen you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornmechanic - Reborns you to Mechanic when you are at least level 200.");
            c.getPlayer().dropMessage(6, "@rebornmihile - Reborns you to Mihile when you are at least level 200.");
            return 1;
        }
    } */
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, "CloudMS has been up for " + StringUtil.getReadableMillis(ChannelServer.serverStartTime, System.currentTimeMillis()));
            return 1;
        }
    }
