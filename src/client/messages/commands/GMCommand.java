...
public class GMCommand {
    ...
    public static class Warning extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                c.getPlayer().dropMessage(0, "!warning victim reason");
                return 0;
            }
            ...
            victim.getMap().startMapEffect(victim.getName() + " has been warned for " + reason + ".\r\nFor more information - Maplestory.co.il", 5120041);
            return 1;
        }
    }
    ...
    public static class EquipById extends CommandExecute {
	...
	public int execute(MapleClient c, String[] splitted) {
		...
		victim.changeEquipById(Integer.parseInt(splitted[2]));
		return 1;
	} 
}
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (c.getPlayer().getMap().getId() == 109020001) {
                ...
                for (MapleMapObject closeplayers : players1) {
                    ...
                    if (playernear.isGM() && playernear.isAlive()); else {
