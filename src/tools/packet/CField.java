...
public class CField {
     ...
     public static byte[] getQuickMoveInfo() {
           ...
           * 00 00 00 00 //0
           * 1E 00 00 00 //30
           * 8B 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 42 61 74 74 6C 65 20 4D 6F 64 65 20
           * 7A 6F 6E 65 20 23 63 42 61 74 74 6C 65 20 53 71 75 61 72 65 23 2C 20 77 68 65
           * 72 65 20 79 6F 75 20 63 61 6E 20 66 69 67 68 74 20 61 67 61 69 6E 73 74 20 6F
           * 74 68 65 72 20 75 73 65 72 73 2E 0A 23 63 4C 76 2E 20 33 30 20 6F 72 20 61 62
           * 6F 76 65 20 63 61 6E 20 70 61 72 74 69 63 69 70 61 74 65 20 69 6E 20 42 61 74
           * 74 6C 65 20 53 71 75 61 72 65 2E
           * Move to the Battle Mode zone #cBattle Square#, where you can fight against
           * other users.\n#cLv. 30 or above can participate in Battle Square.
           * 00 00
           * 66 7B 89 00 //9010022
           * 02 00 00 00 //2
           * 0A 00 00 00 //10
           * 43 00 55 73 65 20 74 68 65 20 23 63 44 69 6D 65 6E 73 69 6F 6E 61 6C 20 4D 69
           * 72 72 6F 72 23 20 74 6F 20 6D 6F 76 65 20 74 6F 20 61 20 76 61 72 69 65 74 79
           * 20 6F 66 20 70 61 72 74 79 20 71 75 65 73 74 73 2E
           * Use the #cDimensional Mirror# to move to a variety of party quests.
           * 00 00
           * 9B 69 8A 00 //9071003
           * 01 00 00 00 //1
           * 14 00 00 00 //20
           * A9 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 70 61 72 74 79 20 7A 6F 6E 65 20 0A
           * 23 63 4D 6F 6E 73 74 65 72 20 50 61 72 6B 23 2C 20 77 68 65 72 65 20 79 6F 75
           * 20 63 61 6E 20 66 69 67 68 74 20 61 67 61 69 6E 73 74 20 73 74 72 6F 6E 67 20
           * 6D 6F 6E 73 74 65 72 73 20 77 69 74 68 20 79 6F 75 72 20 70 61 72 74 79 20 6D
           * 65 6D 62 65 72 73 2E 0A 23 63 4F 6E 6C 79 20 4C 76 2E 20 32 30 20 6F 72 20 61
           * 62 6F 76 65 20 63 61 6E 20 70 61 72 74 69 63 69 70 61 74 65 20 69 6E 20 74 68
           * 65 20 4D 6F 6E 73 74 65 72 20 50 61 72 6B 2E
           * Move to the party zone \n#cMonster Park#, where you can fight against strong
           * monsters with your party members.\n#cOnly Lv. 20 or above can participate in
           * the Monster Park.
           * 00 00
           * 96 54 89 00 //9000086
           * 05 00 00 00 //5
           * 00 00 00 00 //0
           * 49 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 63 6C 6F 73 65 73 74 20 23 63 49 6E
           * 74 65 72 63 6F 6E 74 69 6E 65 6E 74 61 6C 20 53 74 61 74 69 6F 6E 23 20 74 6F
           * 20 79 6F 75 72 20 63 75 72 72 65 6E 74 20 6C 6F 63 61 74 69 6F 6E 2E
           * Move to the closest #cIntercontinental Station# to your current location.
           * 00 00
           * 97 54 89 00 //9000087
           * 03 00 00 00 //3
           * 00 00 00 00 //0
           * 47 00 4D 6F 76 65 20 74 6F 20 74 68 65 20 23 63 46 72 65 65 20 4D 61 72 6B 65
           * 74 23 2C 20 77 68 65 72 65 20 79 6F 75 20 63 61 6E 20 74 72 61 64 65 20 69 74
           * 65 6D 73 20 77 69 74 68 20 6F 74 68 65 72 20 75 73 65 72 73 2E
           * Move to the #cFree Market#, where you can trade items with other users.
           * 00 00
           * 98 54 89 00 //9000088
           * 04 00 00 00 //4
           * 1E 00 00 00 //30
           * 5D 00 4D 6F 76 65 20 74 6F 20 23 63 41 72 64 65 6E 74 6D 69 6C 6C 23 2C 20 74
           * 68 65 20 74 6F 77 6E 20 6F 66 20 50 72 6F 66 65 73 73 69 6F 6E 73 2E 0A 23 63
           * 4F 6E 6C 79 20 4C 76 2E 20 33 30 20 6F 72 20 61 62 6F 76 65 20 63 61 6E 20 6D
           * 6F 76 65 20 74 6F 20 41 72 64 65 6E 74 6D 69 6C 6C
           * Move to #cArdentmill#, the town of Professions.\n#cOnly Lv. 30 or above can
           * move to Ardentmill
           * 00 00
           * 99 54 89 00 //9000089
           * 06 00 00 00 //6
           * 00 00 00 00 //0
           * 30 00 54 61 6B 65 20 74 68 65 20 23 63 54 61 78 69 23 20 74 6F 20 6D 6F 76 65
           * 20 74 6F 20 6D 61 6A 6F 72 20 61 72 65 61 73 20 71 75 69 63 6B 6C 79 2E
           * Take the #cTaxi# to move to major areas quickly.
           * 00 00
           * 79 7B 89 00 //9010041
           * 0A 00 00 00 //10
           * 1E 00 00 00 //30
           * 1D 00 52 65 63 65 69 76 65 20 50 61 72 74 2D 54 69 6D 65 20 4A 6F 62 20 72 65
           * 77 61 72 64 2E
           ...
           * 0D 00 00 00
           * 01 00 00 00
           * 30 00 59 6F 75 20 63 61 6E 20 67 65 74 20 61 20 73 74 79 6C 69 73 68 20 68 61
           * 69 72 63 75 74 20 66 72 6F 6D 20 42 69 67 20 48 65 61 64 77 61 72 64 2E
           * You can get a stylish haircut from Big Headward.
           * 00 00
           * BC 54 89 00
           * 0E 00 00 00
           * 01 00 00 00
           * 31 00 59 6F 75 20 63 61 6E 20 67 65 74 20 70 6C 61 73 74 69 63 20 73 75 72 67
           * 65 72 79 20 66 72 6F 6D 20 44 72 2E 20 50 6C 61 73 74 69 63 20 52 6F 79 2E
     ...
     public static byte[] spawnPlayerMapobject(MapleCharacter chr) {
          ...
          if (chr.getBuffedValue(MapleBuffStat.COMBO) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.COMBO).intValue()),
                         Integer.valueOf(1)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.SHADOWPARTNER) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.SHADOWPARTNER).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getBuffSource(MapleBuffStat.SHADOWPARTNER)), Integer.valueOf(3)));
          }

          if (chr.getBuffedValue(MapleBuffStat.MORPH) != null) {
               mask[MapleBuffStat.MORPH.getPosition(true)] |= MapleBuffStat.MORPH.getValue();
               buffvalue.add(new Pair(Integer.valueOf(chr.getStatForBuff(MapleBuffStat.MORPH).getMorph(chr)),
                         Integer.valueOf(2)));
          ...
          if (chr.getBuffedValue(MapleBuffStat.WIND_WALK) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.WIND_WALK).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.WIND_WALK)), Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.PYRAMID_PQ) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.PYRAMID_PQ).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.PYRAMID_PQ)),
                         Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.OWL_SPIRIT) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.OWL_SPIRIT).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.OWL_SPIRIT)),
                         Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.FINAL_CUT) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.FINAL_CUT).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.FINAL_CUT)), Integer.valueOf(3)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.TORNADO) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.TORNADO).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.TORNADO)), Integer.valueOf(3)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.MECH_CHANGE) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.MECH_CHANGE).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.MECH_CHANGE)),
                         Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.DARK_AURA) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.DARK_AURA).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.DARK_AURA)), Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.BLUE_AURA) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.BLUE_AURA).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.BLUE_AURA)), Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.YELLOW_AURA) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.YELLOW_AURA).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.YELLOW_AURA)),
                         Integer.valueOf(3)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.GIANT_POTION) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.GIANT_POTION).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getTrueBuffSource(MapleBuffStat.GIANT_POTION)),
                         Integer.valueOf(3)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.DARK_METAMORPHOSIS) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.DARK_METAMORPHOSIS).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffSource(MapleBuffStat.DARK_METAMORPHOSIS)),
                         Integer.valueOf(3)));
          }
          if (chr.getBuffedValue(MapleBuffStat.SPIRIT_SURGE) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.SPIRIT_SURGE).intValue()),
                         Integer.valueOf(2)));
               buffvalue.add(
                         new Pair(Integer.valueOf(chr.getBuffSource(MapleBuffStat.SPIRIT_SURGE)), Integer.valueOf(3)));
          }
          ...
          if (chr.getBuffedValue(MapleBuffStat.FAMILIAR_SHADOW) != null) {
               ...
               buffvalue.add(new Pair(Integer.valueOf(chr.getBuffedValue(MapleBuffStat.FAMILIAR_SHADOW).intValue()),
                         Integer.valueOf(3)));
               buffvalue.add(new Pair(Integer.valueOf(chr.getStatForBuff(MapleBuffStat.FAMILIAR_SHADOW).getCharColor()),
                         Integer.valueOf(3)));
          }
          ...
          if (buffSrc > 0) {
               ...
               if ((GameConstants.getMountItem(buffSrc, chr) == 0) && (c_mount != null)
                         && (chr.getInventory(MapleInventoryType.EQUIPPED).getItem((byte) -119) != null)) {
                    mplew.writeInt(c_mount.getItemId());
               } else if ((GameConstants.getMountItem(buffSrc, chr) == 0) && (mount != null)
                         && (chr.getInventory(MapleInventoryType.EQUIPPED).getItem((byte) -19) != null)) {
          ...
          mplew.writeInt(
                    (stat != null) && (stat.getCustomData() != null) ? Integer.valueOf(stat.getCustomData()).intValue()
                              : 0);
          mplew.writeInt(0);
     ...
     public static byte[] getScrollEffect(int chr, Equip.ScrollResult scrollSuccess, boolean legendarySpirit,
          ...
          mplew.writeInt(chr);
          mplew.write(scrollSuccess == Equip.ScrollResult.SUCCESS ? 1
                    : scrollSuccess == Equip.ScrollResult.CURSE ? 2 : 0);
     ...
     public static byte[] spawnFamiliar(MonsterFamiliar mf, boolean spawn, boolean respawn) {
          ...
          mplew.writeShort(respawn ? SendPacketOpcode.SPAWN_FAMILIAR_2.getValue()
                    : SendPacketOpcode.SPAWN_FAMILIAR.getValue());
     ...
     public static byte[] magicAttack(int cid, int tbyte, int skill, int level, int display, byte speed,
          ...
          return addAttackInfo(3, cid, tbyte, skill, level, display, speed, damage, lvl, (byte) 0, unk, charge, null,
                    0);
     }
     ...
     public static byte[] moveFollow(Point otherStart, Point myStart, Point otherEnd,
     ...
     public static class NPCPacket {
          ...
          public static byte[] getMapSelection(int npcid, String sel) {
               ...
               mplew.writeInt(npcid == 9010022 ? 1/* 31 in v124? */ : npcid == 9201231 ? 1/* 31 in v124? */ : 0/*
                                                                                                                * or 3,
                                                                                                                * not
                                                                                                                * confirmed
                                                                                                                */); // UI
