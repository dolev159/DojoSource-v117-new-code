...
function action(mode, type, selection) {
	...
	case 1:
		...
		break;
	case 2:
		cm.sendNextPrevS("Help you do what? I'm not moving any couches!", 17);
		break;
	case 3:
	...
	case 7:
		...
		break;
	case 8:
		cm.sendNextS("Mwahaha! You found our base, little Mapling, now you are going to be our slave... FOR LIFE!", 5, 9201174);
		break;
	case 9:
		cm.sendNextPrevS("Can anybody hear me? Please help!", 5, 9201172);
		break;
	case 10:
		cm.sendNextPrevS("Foolish, large-headed creature! You will never escape!", 5, 9201174);
		break;
	case 11:
		cm.sendNextPrevS("Oh, jeez. The aliens are trying to keep themselves secret by kidnapping people! Either that, or they're HUNGRY!", 17);
		break;
	case 12:
		cm.sendNextPrevS("(I have to go tell #b#p9201050##k before all the people of his town get turned into slaves, or stew, or slave stew!)", 17);
		break;
	case 13:
