...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendNext("Hey, I'm #b#p9000013##k, if you're not busy and all ... then can I hang out with you? I heard there are people gathering up around here for an #revent#k but I don't want to go there by myself ... Well, do you want to go check it out with me?");
		break;
	case 1:
