...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendNext("Well, hello! Welcome to the Lian Hua Hua Skin-Care~! Would you like to have a firm, tight, healthy looking skin like mine? With #b#t5153015##k, you can let us take care of the rest and have the kind of skin you've always wanted~!");
		break;
	case 1:
