...
function action(mode, type, selection) {
	...
	case 0:
		if (cm.getPlayer().getGender() < 1)
			...
			cm.sendStyle("Welcome, welcome! Not happy with your look? Neither am I. But for #b#t5152057##k, I can transform your face and get you the look you've always wanted.", face);
			break;
	case 1:
