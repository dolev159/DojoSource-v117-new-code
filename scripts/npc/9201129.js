...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendNext("#r[Requirements to Enter] \r\n\r\n#b      1.You must be a Magician, a Blaze Wizard, a Battle Mage, or Evan.\r\n      2.You must be under Level 40.\r\n      3.You must have Marbas' Emblem.");
		break;
	case 1:
		if (Math.floor(cm.getPlayer().getJob() / 100 % 10) != 2 || cm.getPlayer().getLevel() > 40 || cm.getPlayer().itemQuantity(4032495) < 1) {
			cm.dispose();
			return;
			}
