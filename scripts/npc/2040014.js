...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendSimple("Hello! I'm #b#p2040014##k, and l'm in charge of mini-games around these parts. You look like you could use a good mini-game, and I can help! All right... What do you want to do? \r\n#L0##bCreate a mini-game item#l\r\n#L1#Listen to the explanation on mini-games#l");
		break;
	case 1:
		if (selection == 0) {
...
function action0(mode, type, selection) {
	...
	case 3:
		...
		omok = [4080006, 4080007, 4080008, 4080009, 4080010, 4080011];
		omok1 = [4030013, 4030013, 4030014, 4030015, 4030015, 4030015];
		omok2 = [4030014, 4030016, 4030016, 4030013, 4030014, 4030016];
		omok3 = ["Bloctopus", "Bloctopus", "Pink Teddy", "Panda Teddy", "Panda Teddy", "Panda Teddy"];
		omok4 = ["Pink Teddy", "Trixter", "Trixter", "Bloctopus", "Pink Teddy", "Trixter"];
