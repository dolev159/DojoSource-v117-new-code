...
function action(mode, type, selection) {
	...
	case 0:
		...
		if (Math.floor(cm.getPlayer().getJob() / 100 % 10) != 2) {
			cm.sendNext("You're no magician. I am not qualified to judge you. If you want to explore Zakum, you will need to find a master of your job class to be your guide.");
			cm.dispose();
			return;
			}
