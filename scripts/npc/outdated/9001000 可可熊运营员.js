...
function action(mode, type, selection) {
	...
	status++;
		if (status == 0) {
			...
			if (selection == 3){
				catagory = selection;
				cm.sendSimple("#rETC#k:\n\r\n\r																												#b#L6##v5221001#Trade 1000 points (#t5221001#)#l#k																				#b#L7##v5221001#Trade Enchanted Scroll (#r1000#b points)#l#k																				#b#L8##v3993002#Trade 10000 points (#t3993002#)#l#k																					#b#L9##v3993002#Trade Bamboo Luck Sack (#r10000#b points)#l#k																		#b#L10##v2070018#Trade 300,000 points (Balanced Fury)#l#k 																#b#L11##v2070016#Trade 150,000 points (Crystal Ilbi)#l#k 																				#b#L12##v1122017#Trade 30,000 points (Fairy Pendant, lasts 1 day)#l#k 																	#b#L13##v5680021#Trade 150,000 points (Chair Gachapon Ticket)#l#k 																		#b#L14##v1112927#Trade 150,000 points (Happy Ring)#l#k																				#b#L15##v2046375#Trade 10,000 points (Accessory Scroll 20%)#l																		#b#L16##v2046376#Trade 15,000 points (Accessory Scroll 40%)#l																		#b#L17##v2531000#Trade 400,000 points (Protection Scroll)#l#k");
			} else if (selection == 4){
				catagory = selection;
				var selStr = "#rTimeless Equipments#k:\n\r\n\r#";
				for (var i = 0; i < TLEQ.length; i++) {
					selStr += "#b#L" + i + "##v" + TLEQ[i] + ":#Trade "+ TLEQBP[i] + " points (#t" + TLEQ[i] + "#)#l\r\n";
				}
				...
				for (var i = 0; i < FLR.length; i++) {
					selStr += "#b#L" + i + "##v" + FLR[i] + ":#Trade "+ FLRBP[i] + " points (#t" + FLR[i] + "#)#l\r\n";
				}
				cm.sendSimple(selStr + "#k\n");
			} else {
				cm.dispose();
...
//-------------------------------ETC--------------------------------------
				...
				default :
					...
					cm.sendYesNo("Do you wanna trade #v" + ETC[selection] + ":##b#t" + ETC[selection] + " #?\n #r(" + ETCpoints[selection] + " points)#b#l\r\n");
				}
			} else if (catagory == 4){
				PrevCatagory = catagory;
				ITEM = TLEQ;
				ITEMpoints = TLEQpoints;
				cm.sendYesNo("Do you wanna trade #v" + TLEQ[selection] + ":##b#t" + TLEQ[selection] + " #?\n #r(" + TLEQpoints[selection] + " points)#b#l\r\n");
			} else if (catagory == 5){
				PrevCatagory = catagory;
				ITEM = FLR;
				ITEMpoints = FLRpoints;
				cm.sendYesNo("Do you wanna trade #v" + FLR[selection] + ":##b#t" + FLR[selection] + " #?\n #r(" + FLRpoints[selection] + " points)#b#l\r\n");
			}
		} else if (status == 3){
			if (PrevCatagory == 4){
				var record = cm.getQuestRecord(150001);
