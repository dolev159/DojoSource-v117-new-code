...
maps = [["#gForest of Tenacity : Stage 1 - 2 [Easy]#k\r\n", 910530000], ["#bForest of Tenacity : Stage 3 - 4 [Normal]#k", 910530100], ["#bForest of Endurance : Stage 1 - 2 [Normal]#k\r\n", 910130000], ["#rForest of Tenacity : Stage 5 - 7 [Hard]#k", 910530200], ["#rForest of Endurance : Stage 3 - 5 [Hard]#k", 910130100], ["#rHaunted House : Ghost Chimney [Hard]#k\r\n", 682000200]];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 100) {
            var talk = "#eThere are alot of levels for make your personally jumping quest better. \r\nChoose yourself destination. \r\n\r\n#g[Easy]#k - between 2 to 4 points.\r\n#b[Normal]#k - between 4 to 8 points.\r\n#r[Hard]#k - between 8 to 20 points.\r\n\r\n#rThere will be an entrance fee of 10 NX.#b";
