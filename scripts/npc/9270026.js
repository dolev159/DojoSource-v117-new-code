...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
    cm.sendSimple ("Hello #r#h ##k, I'm friend of Aqua Ballon and I can exchange.\r\nYou have #r" + cm.getVPoints() +"#k Vote points#k." +
                "\r\n#L2000#Scrolls#l" + 
				"\r\n#L4000#Other#l");
	} else if (selection == 4000) {
                cm.sendSimple ("You Currently have#r [" + cm.getVPoints() + "]#k Vote Points." +
                "#k\r\nWhat would you like?" +
                "#k\r\n#L4001##bChair Gachapon x4 - 2 Vote points" +
		"#k\r\n#L4002##bOnyx Apple x5 - 2 Vote points" 
				);
