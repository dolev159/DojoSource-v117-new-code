...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendSimple("Hello there~ I am Irene from Singapore Airport. I was transferred to Victoria Island to celebrate new opening of our service! How can I help you? \r\n#L0##bI would like to buy a plane ticket to Singapore#l\r\n#L1#Let me go in to the departure point.#l");
		break;
	default:
...
function action1(mode, type, selection) {
	...
	case 1:
		...
		break;
	case 2:
		if (cm.getPlayer().itemQuantity(4031731) < 1) {
		...
		if (em.getProperty("entry") == "false") {
			cm.sendOk("We are sorry but the gate is closed 1 minute before the departure.");
			cm.dispose();
			return;
			}
			cm.gainItem(4031731, -1);
