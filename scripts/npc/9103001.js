...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var pqType = Packages.server.MaplePQManager.PQType.LUDI_MAZE;
		if (Packages.server.MaplePQManager.canEnter(cm.getPlayer(), pqType)) {
		    if (em == null) {//EVENT ERROR
