...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendNext("Hey, I'm #b#p9000011##k, if you're not busy and all ... then can I hang out with you? I heard there are people gathering up around here for an #revent#k but I don't want to go there by myself ... Well, do you want to go check it out with me?");
		break;
	case 1:
		cm.sendSimple("Huh? What kind of an event? Well, that's...\r\n#L7##bWhat kind of an event is it?#l\r\n#L8#Explain the event game to me.#l\r\n#L9#Alright, let's go!#l");
		break;
	default:
...
function action8(mode, type, selection) {
	...
	case 2:
		...
		break;
	case 3:
		cm.sendNext(Text[selection][mode-1]);
		break;
	case 4:
		cm.dispose();
}
