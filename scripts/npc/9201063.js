...
function action(mode, type, selection) {
	...
	switch (status) {
	case 0:
		cm.sendSimple("I'm Ari the assistant. If you have #b#t5150052##k or #b#t5151035##k by any chance, then how about letting me change your hairdo? \r\n#L0##bHaircut(REG coupon)#l\r\n#L1#Dye your hair(REG coupon)#l");
		break;
	default:
...
function action0(mode, type, selection) {
	...
	case 1:
		if (cm.getPlayer().getGender() < 1)
			hair = [30250, 30110, 30230, 30050, 30280, 30410, 30730, 30160, 30200, 30440, 30360, 30400];
		else
			hair = [31150, 31310, 31220, 31300, 31260, 31160, 31730, 31410, 31410, 31720, 31560, 31450];
