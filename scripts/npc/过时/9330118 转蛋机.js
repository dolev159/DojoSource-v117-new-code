...
function start() {
	...
	if (cm.haveItem(5220000, 1)) {
		cm.sendSimple("冒险岛转蛋机中有各类#b装备、卷轴或稀有新奇的道具#k噢！使用“#b#t5220000##k”就可以抽奖，否则是不可以使用我的。现在要玩转蛋机么? \r\n#b#L2#试试手气吧#l#k\r\n\r\n\r\n下期部分奖励展示:\r\n" + jpzs);
	} else {
		cm.sendSimple("冒险岛转蛋机中有各类#b装备、卷轴或稀有新奇的道具#k噢！使用“#b#t5220000##k”就可以交换。 假如不买转蛋券的话，是不可以使用我的。现在要玩转蛋机么?    \r\n\r\n#r你背包里没#v5220000##z5220000#\r\n\r\n#k部分奖励展示:\r\n" + jpzs + "");
}
}
...
function action(mode, type, selection) {
	if (mode == 1) {
		...
		if (item != -1) {
			...
			cm.sendOk("你确实有#b#t5220000##k吗？如果是，请你确认在背包的装备，消耗，其它窗口中是否有一格以上的空间。");
			}
			cm.safeDispose();
		} else {
