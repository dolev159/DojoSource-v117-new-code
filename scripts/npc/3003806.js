...
var player;
var em;
const ExpeditionType = Java.type('handling.world.exped.ExpeditionType');
var exped = ExpeditionType.DARKNELL;
var expedName = "Darknell";
var expedBoss = "Darknell";
var expedMap = "Final Horizon";
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("DarknellBattle");
