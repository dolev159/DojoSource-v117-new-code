...
function action2(mode, type, selection) {
	...
	case 3:
		...
		break;
	case 4:
		if (qm.getPlayer().itemQuantity(4000633) < 1 || qm.getPlayer().itemQuantity(4000336) < 1 || qm.getPlayer().getInventory(Packages.client.inventory.MapleInventoryType.USE).getNumFreeSlot() < 1) {
