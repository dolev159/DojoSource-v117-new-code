...
function start(mode, type, selection) {
	...
	case 1:
		...
		break;
	default:
		if (qm.getPlayer().getQuestNAdd(Packages.server.quest.MapleQuest.getInstance(1400)).getStatus() < 2) {
...
function action2(mode, type, selection) {
	...
	case 2:
		...
		break;
	case 3:
		qm.sendNextPrev("You know that Magicians have their Job Advancements earlier than other jobs, right? Grendel the Really Old will contact you once you reach Lv. 8. Become an amazing Magician!");
		break;
	case 4:
		qm.dispose();
}
...
function action4(mode, type, selection) {
	...
	case 2:
		...
		break;
	case 3:
		qm.sendNextPrev("If you get up to #bLv. 10#k, he'll contact you. Become a great Thief, got it?");
		break;
	case 4:
		qm.dispose();
}
...
function action5(mode, type, selection) {
	...
	case 2:
		...
		break;
	case 3:
		qm.sendNextPrev("She'll contact you once you reach #bLv. 10#k. Become a masterful Pirate!");
		break;
	case 4:
		qm.dispose();
}
