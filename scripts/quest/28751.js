...
function start(mode, type, selection) {
	...
	case 3:
		...
		qm.getClient().getSession().write(Packages.tools.packet.CWvsContext.getTopMsg("Avoid the Alien Scouts and gather 5 pieces of ore from around the map to use as fuel."));
		qm.dispose();
}
}
