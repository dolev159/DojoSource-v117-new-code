...
function start(mode, type, selection) {
	...
	case 3:
		...
		Packages.server.quest.MapleQuest.getInstance(21719).forceComplete(qm.getPlayer(), qm.getNpc());
		qm.getClient().getSession().write(Packages.tools.packet.CWvsContext.getShowQuestCompletion(21719));
		qm.dispose();
}
}