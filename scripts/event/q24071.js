...
function playerEntry(eim, player) {//傳送進事件地圖
	player.changeMap(eim.getMapInstance(910080010), eim.getMapInstance(910080010).getPortal(0));
}
...
function monsterValue(eim, player, mob) {//殺怪後觸發
	if (mob.getId() == 9300285) {
		eim.getMapInstance(910080010).spawnNpc(1033222, new java.awt.Point(5600, 454));
		}
		return 1;
}
