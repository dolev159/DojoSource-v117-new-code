...
function setup(level, lobbyid) {//開始事件，時間
	...
	eim = em.newInstance("q22611");

	eim.setInstanceMap(931050700).resetFully();
	eim.setInstanceMap(931050701).resetFully();
...
function playerEntry(eim, player) {//傳送進事件地圖
	player.changeMap(eim.getMapInstance(931050700), eim.getMapInstance(931050700).getPortal(1));
}
