...
function playerEntry(eim, player) {//傳送進事件地圖
	player.changeMap(eim.getMapInstance(926150000), eim.getMapInstance(926150000).getPortal(1));
}
...
function monsterValue(eim, player, mob) {//殺怪後觸發
	if (mob.getId() == 9300457) {
		player.changeMap(eim.getMapInstance(926150010), eim.getMapInstance(926150010).getPortal(0));
		}
		return 1;
}
