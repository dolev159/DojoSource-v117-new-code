...
function action(mode, type, selection) {
	...
	case 12:
		...
		break;
	case 13:
		ms.sendNextS("Put your tongue back in your mouth, Bark. Tell me about your ship, alien. It was awfully small to be pumping out that kind of power. You sure you're not just trying to cover up some secret government experiment?", 5, 9270089);
		break;
	case 14:
	...
	case 15:
		...
		break;
	case 16:
		ms.sendNextS("My kin figured out focus-beam propulsion a hundred years ago. You can believe whatever you want, but it works.", 3);
		break;
	case 17:
		ms.sendNextPrevS("#b(With that kind of power, the Nautilus would be unstoppable! I am gonna be SO RICH.)", 5, 9270089);
		break;
	case 18:
		ms.getClient().getSession().write(Packages.tools.packet.CField.UIPacket.getDirectionInfo(1, 1000));
		break;
	...
	case 23:
		...
		break;
	case 24:
		ms.sendNextS("Oh! I know that look! This is the thing you were looking for at the crash, ain't it?", 5, 9270088);
		break;
	case 25:
		ms.sendNextS("That's the one. Thanks for... giving it back to me. I'll make it up to you.", 3);
		break;
	case 26:
		ms.sendNextPrevS("Ha! I'd be careful about what you say around old Black Bark. He never forgets a debt!", 5, 9270089);
		break;
	case 27:
		ms.getClient().getSession().write(Packages.tools.packet.CField.UIPacket.getDirectionInfo(1, 1000));
		break;
	case 28:
		ms.sendNextS("#b(These outlaws should be the perfect bunch to keep me hidden for now. All I've gotta do is stick with them and lay low.)", 3);
		break;
	case 29:
